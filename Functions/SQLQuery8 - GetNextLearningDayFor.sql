...
ALTER FUNCTION GetNextLearningDayFor(@group_name AS NVARCHAR(10))RETURNS TINYINT
BEGIN
	DECLARE 
		@current_day AS TINYINT = DATEPART(WEEKDAY, dbo.GetLastDayForGroup(@group_name));
	DECLARE
