...
(
	...
	CONSTRAINT FK_CompliteDisciplines_Disciplines FOREIGN KEY (discipline) REFERENCES Disciplines(discipline_id),
	CONSTRAINT FK_CompliteDisciplines_Groups FOREIGN KEY ([group]) REFERENCES Groups(group_id)
);